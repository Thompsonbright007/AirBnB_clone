...
class TestState(unittest.TestCase):
    ...
    def test_attributes_exist(self):
        """
        Test that class State has all the required attributes and methods
        """
    ...
    def test_is_subclass(self):
        """
        it checks whether the State instance is a subclass of basemodel
        """
    ...
    def test_has_inherited_attributes(self):
        ...
        Also checks if the State's attributes are present
        """
